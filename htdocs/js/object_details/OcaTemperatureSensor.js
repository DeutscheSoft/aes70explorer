...
class OcaTemperatureSensorDetails extends TemplateComponent.fromString(template) {
...
registerObjectDetailTemplate(OcaTemperatureSensorDetails, 'temperaturesensor');

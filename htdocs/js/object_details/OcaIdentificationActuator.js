...
<div class="grid">
  ...
  <aux-label %bind={{ this.ActiveBind }}></aux-label>
</div>
`;

class OcaIdentificationActuatorDetails extends TemplateComponent.fromString(template) {
...
registerObjectDetailTemplate(OcaIdentificationActuatorDetails, 'identificationactuator');

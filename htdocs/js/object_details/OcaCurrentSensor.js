...
class OcaCurrentSensorDetails extends TemplateComponent.fromString(template) {
  ...
  constructor() {
    ...
    this.ReadingBind = [{ src: '/Reading', name: 'label', readonly: true,
      transformReceive: v => v.toFixed(3) + 'A' }];
...
registerObjectDetailTemplate(OcaCurrentSensorDetails, 'currentsensor');
